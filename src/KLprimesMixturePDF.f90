function klprimesmixturepdf( x, n, obsr, obsd, delta, maxitr, ier )
...
!*********************************************************************************************!
    ...
    !  Function
    !  --------
    real(kind=8) :: klprimesmixturepdf

    !  Arguments
    !  ---------
    real(kind=8), intent(in)  :: x, obsr, obsd, delta
    integer,      intent(in)  :: n, maxitr
    integer, intent(out)      :: ier

    !  Local declarations
    !  ------------------
    real(kind=8), external  :: klprimesmixturecdf
    real(kind=8)            :: rer  ! real-valued error 

    ier = 0
    klprimesmixturepdf = dfridr( func, x, 0.1_8, rer )
...
contains
    function func( x )
        ...
        real(kind=8)  :: func
        integer       :: iok
        func = klprimesmixturepdf(x, n, obsr, obsd, delta, maxitr, iok)
    end function func
...
end function klprimesmixturepdf
